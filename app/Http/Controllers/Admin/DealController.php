...
class DealController extends Controller
{
    ...
    {
        $flash_deal = FlashDeal::where('deal_type', 'flash_deal')->latest()->paginate(25);
    ...
    {
        $flash_deals = FlashDeal::where('deal_type', 'feature_deal')->latest()->paginate(25);
    ...
    {
        $deals = DealOfTheDay::latest()->paginate(25);
